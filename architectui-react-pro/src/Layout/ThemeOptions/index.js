                  ...
                  <ListGroupItem>
                    <div className="widget-content p-0">
                      <div className="widget-content-wrapper">
                        ...
                        <div
                          className={cx(
                            'widget-content-right text-success opacity-6',
                            {
                    ...
                    <div className="theme-settings-swatches">
                      ...
                      <div
                        className={cx('swatch-holder bg-info', {
                          active:
                            headerBackgroundColor ===
                            'bg-info header-text-light'
                        })}
                        onClick={() =>
                          setHeaderBackgroundColor('bg-info header-text-light')
                        }
                      />
                      <div
                      ...
                      <div
                        ...
                        onClick={() =>
                          setHeaderBackgroundColor('bg-light header-text-dark')
                        }
                      />
                      <div
                        ...
                        onClick={() =>
                          setHeaderBackgroundColor('bg-dark header-text-light')
                        }
                      />
                      <div
                        ...
                        onClick={() =>
                          setHeaderBackgroundColor('bg-focus header-text-light')
                        }
                      />
                      <div
                      ...
                      <div
                        ...
                        onClick={() =>
                          setHeaderBackgroundColor('bg-royal header-text-light')
                        }
                      />
                      <div
                      ...
                      <div
                        className={cx('swatch-holder bg-malibu-beach', {
                          active:
                            headerBackgroundColor ===
                            'bg-malibu-beach header-text-dark'
                        })}
                        onClick={() =>
                          setHeaderBackgroundColor(
                            'bg-malibu-beach header-text-dark'
                      ...
                      <div
                        className={cx('swatch-holder bg-happy-itmeo', {
                          active:
                            headerBackgroundColor ===
                            'bg-happy-itmeo header-text-dark'
                        })}
                        onClick={() =>
                          setHeaderBackgroundColor(
                            'bg-happy-itmeo header-text-dark'
                  ...
                  <ListGroupItem>
                    ...
                    <div className="theme-settings-swatches">
                      <div
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-primary sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-secondary', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-secondary sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-success', {
                          active:
                            backgroundColor === 'bg-success sidebar-text-light'
                        })}
                        onClick={() =>
                          setBackgroundColor('bg-success sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-info', {
                          active:
                            backgroundColor === 'bg-info sidebar-text-light'
                        })}
                        onClick={() =>
                          setBackgroundColor('bg-info sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-warning', {
                          active:
                            backgroundColor === 'bg-warning sidebar-text-dark'
                        })}
                        onClick={() =>
                          setBackgroundColor('bg-warning sidebar-text-dark')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-danger', {
                          active:
                            backgroundColor === 'bg-danger sidebar-text-light'
                        })}
                        onClick={() =>
                          setBackgroundColor('bg-danger sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-light', {
                          active:
                            backgroundColor === 'bg-light sidebar-text-dark'
                        })}
                        onClick={() =>
                          setBackgroundColor('bg-light  sidebar-text-dark')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-dark', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-dark sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-focus', {
                          active:
                            backgroundColor === 'bg-focus sidebar-text-light'
                        })}
                        onClick={() =>
                          setBackgroundColor('bg-focus sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-alternate', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-alternate sidebar-text-light')
                        }
                      />
                      ...
                      <div
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-night-sky sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-slick-carbon', {
                      ...
                      <div
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-asteroid sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-royal', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-royal sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-warm-flame', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-warm-flame sidebar-text-dark')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-night-fade', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-night-fade sidebar-text-dark')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-sunny-morning', {
                      ...
                      <div
                        className={cx('swatch-holder bg-amy-crisp', {
                          active:
                            backgroundColor === 'bg-amy-crisp sidebar-text-dark'
                        })}
                        onClick={() =>
                          setBackgroundColor('bg-amy-crisp sidebar-text-dark')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-heavy-rain', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-heavy-rain sidebar-text-dark')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-mean-fruit', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-mean-fruit sidebar-text-dark')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-malibu-beach', {
                          active:
                            backgroundColor ===
                            'bg-malibu-beach sidebar-text-dark'
                        })}
                        onClick={() =>
                          setBackgroundColor(
                            'bg-malibu-beach sidebar-text-dark'
                      ...
                      <div
                        className={cx('swatch-holder bg-deep-blue', {
                          active:
                            backgroundColor === 'bg-deep-blue sidebar-text-dark'
                        })}
                        onClick={() =>
                          setBackgroundColor('bg-deep-blue sidebar-text-dark')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-ripe-malin', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-ripe-malin sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-arielle-smile', {
                      ...
                      <div
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-plum-plate sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-happy-fisher', {
                      ...
                      <div
                        className={cx('swatch-holder bg-happy-itmeo', {
                          active:
                            backgroundColor ===
                            'bg-happy-itmeo sidebar-text-dark'
                        })}
                        onClick={() =>
                          setBackgroundColor('bg-happy-itmeo sidebar-text-dark')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-mixed-hopes', {
                      ...
                      <div
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-grow-early sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-love-kiss', {
                        ...
                        onClick={() =>
                          setBackgroundColor('bg-love-kiss sidebar-text-light')
                        }
                      />
                      <div
                        className={cx('swatch-holder bg-premium-dark', {
                        ...
                        <div className="widget-content-right">
                          <ButtonGroup size="sm">
                            <Button
                              ...
                              color="primary"
                              onClick={() =>
                                setBackgroundImageOpacity('opacity-04')
                              }
                            >
                              4%
                            </Button>
                            <Button
                              ...
                              color="primary"
                              onClick={() =>
                                setBackgroundImageOpacity('opacity-06')
                              }
                            >
                              6%
                            </Button>
                            <Button
                              ...
                              color="primary"
                              onClick={() =>
                                setBackgroundImageOpacity('opacity-08')
                              }
                            >
                              8%
                            </Button>
                            <Button
                              ...
                              color="primary"
                              onClick={() =>
                                setBackgroundImageOpacity('opacity-1')
                              }
                            >
                              10%
                            </Button>
                            <Button
                              ...
                              color="primary"
                              onClick={() =>
                                setBackgroundImageOpacity('opacity-15')
                              }
                            >
                              15%
                            </Button>
                  ...
                  >
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar6
                      })}
                    >
                      <a
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar7
                      })}
                    >
                      <a
                        className="img-holder switch-trigger"
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar8
                      })}
                    >
                      <a
                        className="img-holder switch-trigger"
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar9
                      })}
                    >
                      <a
                        className="img-holder switch-trigger"
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar10
                      })}
                    >
                      <a
                        className="img-holder switch-trigger"
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar1
                      })}
                    >
                      <a
                        className="img-holder switch-trigger"
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar2
                      })}
                    >
                      <a
                        className="img-holder switch-trigger"
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar3
                      })}
                    >
                      <a
                        className="img-holder switch-trigger"
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar4
                      })}
                    >
                      <a
                        className="img-holder switch-trigger"
                    ...
                    <div
                      className={cx('swatch-holder swatch-holder-img', {
                        active: backgroundImage === sideBar5
                      })}
                    >
                      <a
                        className="img-holder switch-trigger"
                    ...
                    <div className="widget-content p-0">
                      <div className="widget-content-wrapper">
                        ...
                        <div className="widget-content-left">
                          ...
                          <div className="widget-subheading">
                            Enable an alternate style for the page sections
                            tabs!
                          </div>
                        </div>
                        <div
